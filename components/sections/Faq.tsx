...
const ITEMS: QA[] = [
  ...
  },
  {
    ...
    a: "Один магазин, каталог до 50 товаров, движение товаров и денег и базовые документы — этого хватает, чтобы начать. Сотрудники, аналитика и интеграции доступны на платных тарифах.",
  },
  {
    icon: CreditCard,
